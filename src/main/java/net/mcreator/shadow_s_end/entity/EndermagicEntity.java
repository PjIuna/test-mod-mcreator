...
public class EndermagicEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Items.END_CRYSTAL);
	private int knockback = 0;

	public EndermagicEntity(EntityType<? extends EndermagicEntity> type, Level world) {
		super(type, world);
	}

	public EndermagicEntity(EntityType<? extends EndermagicEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public EndermagicEntity(EntityType<? extends EndermagicEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static EndermagicEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 5, 5);
	}

	public static EndermagicEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 5, 5);
	}

	public static EndermagicEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		EndermagicEntity entityarrow = new EndermagicEntity(ShadowsAndPjlunasEndModEntities.ENDERMAGIC.get(), entity, world, null);
	...
	public static EndermagicEntity shoot(LivingEntity entity, LivingEntity target) {
		EndermagicEntity entityarrow = new EndermagicEntity(ShadowsAndPjlunasEndModEntities.ENDERMAGIC.get(), entity, entity.level(), null);
